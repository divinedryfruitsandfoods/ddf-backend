...
public class FileConstant {
    ...
    public static final String USER_FOLDER = System.getProperty("user.home") + "/divinedryfruitsandfoods/profileAvatars/";
    public static final String DEFAULT_CATEGORY_IMAGE_PATH = System.getProperty("user.home") + "/divinedryfruitsandfoods/categoryimages/";
